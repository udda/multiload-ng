...
#ifndef ML_HEADER__PROVIDER_RANDOM_H__INCLUDED
#define ML_HEADER__PROVIDER_RANDOM_H__INCLUDED
ML_HEADER_BEGIN


extern const MlGraphTypeInterface ML_PROVIDER_RANDOM_IFACE;
...
ML_HEADER_END
#endif /* ML_HEADER__PROVIDER_RANDOM_H__INCLUDED */
