...
#ifndef ML_HEADER__PROVIDER_CPUFREQ_H__INCLUDED
#define ML_HEADER__PROVIDER_CPUFREQ_H__INCLUDED
ML_HEADER_BEGIN


extern const MlGraphTypeInterface ML_PROVIDER_CPUFREQ_IFACE;
...
void
ml_provider_cpufreq_caption (MlCaption *caption, MlDataset *ds, mlPointer provider_data);


ML_HEADER_END
#endif /* ML_HEADER__PROVIDER_CPUFREQ_H__INCLUDED */
